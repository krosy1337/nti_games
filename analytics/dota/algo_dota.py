    ...
    def get_final_res(self, a, b, c, d, e, f, solo_empty, party_empty):
        ...
        if solo_empty:
            ...
            return {"score": score,
                    ...
                    "benefit": round(b[1], 2) if (round(b[1], 2) < 100) else 100,
        ...
        if party_empty:
            ...
            return {"score": score,
                    ...
                    "benefit": round(e[1], 2)  if (round(b[1], 2) < 100) else 100,
        ...
        return {"score": score,
                ...
                "benefit": round((b[1] + e[1]) / 2, 2) if (round((b[1] + e[1]) / 2, 2) < 100) else 100,
